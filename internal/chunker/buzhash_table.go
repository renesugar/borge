...
//
// This file is a Go port of the table_base constant in borg's
...
// buzhashTableBase is the fixed 256-entry table the 32-bit buzhash chunker XORs with
// the repository seed. It is part of the on-disk format: borg 1.x wrote chunks cut
// with it, and borg 2 keeps the chunker bit-compatible, so these values can never
// change. Transcribed verbatim from borg.
var buzhashTableBase = [256]uint32{
